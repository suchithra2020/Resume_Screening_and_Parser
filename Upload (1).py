...
if menu_id == 'Home':
    ...
    tab1, tab2 = st.tabs(["💾 About Project","🦸‍♂️ About Students"])
    ...
    with tab2:
        ...
        with col1:
            ...
            st.markdown('<table>\
                <tr>\
                <td>\
                <h2>Keerthana Reddy </h2>\
                <p>Registration Number: MS214435</p>\
                <p>Email: keerthana.reddy012345@gmail.com</p>\
                <p>Phone Number:9108601711</p>\
                </td>\
                </tr>\
                <tr>\
                <td>\
                <h2>Suchithra Udupa</h2>\
                <p>Registration Number: Ms214440</p>\
                <p>Email: suchithramcc24@gmail.com</p>\
                <p>Phone Number: 6366048745</p>\
                </td>\
                </tr>\
...
def extract_text_from_pdf(pdf_file):
    ...
    return textdef extract_text_from_pdf(pdf_path):
    """
    Extracts text from a PDF file.
...
def generate_pdf(text, pdf_path):
    ...
    c.drawString(100, 750, text)  # Adjust the pdef extract_text_from_docx(docx_path):
